...
|--------------|--------------|--------------------------------------------|
| 1 | Linear Models | @sec-linear-covcor ; @sec-reporting-and-presenting-results (8.2 & 8.3) |
| 2 | Linear Models | @sec-binary-predictors ; @sec-statistical-significance ; @sec-predicted-residual-values (5.1 & 5.2) ; @sec-reporting-and-presenting-results (8.4) |
| 3 | Linear Models | @sec-multiple-linear-regression ; @sec-predicted-residual-values (5.3) ; @sec-model-fit ; @sec-reporting-and-presenting-results (8.4 - 8.7) |
