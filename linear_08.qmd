...
# Creating dummy variables for all (non-missing) categories of these variables
...
The `modelsummary` website shows another way of renaming variables but within the confines of the command itself; see [here](
https://modelsummary.com/vignettes/datasummary.html#renaming-with){target="_blank"}. 
